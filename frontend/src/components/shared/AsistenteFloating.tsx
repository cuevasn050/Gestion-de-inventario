...
export default function AsistenteFloating() {
  ...
  return (
    <div className="relative w-full h-full">
      ...
      <div className="sticky bottom-6 z-50 flex justify-end pr-6" style={{ marginTop: 'auto' }}>
        <button
      ...
      {showAsistente && (
        <div className="sticky bottom-24 z-50 flex justify-end pr-6" style={{ marginTop: 'auto' }}>
