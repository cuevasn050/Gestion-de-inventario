...
export default function AsistenteFloating() {
  ...
  return (
    <>
      ...
      <div className="sticky bottom-6 z-50 flex justify-end pr-6" style={{ alignSelf: 'flex-end', width: 'fit-content', marginLeft: 'auto', overflow: 'visible' }}>
        <button
      ...
      {showAsistente && (
        <div className="sticky bottom-24 z-50 flex justify-end pr-6" style={{ alignSelf: 'flex-end', width: 'fit-content', marginLeft: 'auto', overflow: 'visible' }}>
