...
export default function AsistenteFloating() {
  ...
  return (
    <>
      {/* Botón flotante - Siempre visible, se mueve con el scroll */}
      <button
      ...
      {/* Widget flotante del asistente - Aparece cuando está abierto, también se mueve con el scroll */}
      {showAsistente && (
        <div className="fixed bottom-24 right-6 w-96 h-[600px] z-50 flex flex-col shadow-2xl rounded-2xl overflow-hidden border border-gray-700/50 bg-gray-900">
