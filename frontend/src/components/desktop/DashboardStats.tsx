                ...
                <div className="relative">
                  ...
                  >
                    ...
                    {datosParaRegresion.map((d, i) => {
                      ...
                      // Si no hay préstamos, no mostramos el punto ni el texto (petición de usuario)
          ...
          <div className="bg-gray-800/50 rounded-xl p-5 border border-gray-700/50">
            ...
            {(() => {
              ...
              datos.forEach((item) => {
                ...
                // CORRECCIÓN: Si el ángulo es 360 (100%), dibujar un círculo completo
                // Los arcos SVG fallan si el punto inicio == fin
                let pathData;
                if (Math.abs(angulo - 360) < 0.1) {
                  pathData = [
                    `M ${centroX} ${centroY - radio}`,
                    `A ${radio} ${radio} 0 1 1 ${centroX} ${centroY + radio}`,
                    `A ${radio} ${radio} 0 1 1 ${centroX} ${centroY - radio}`,
                    'Z'
                  ].join(' ')
                } else {
